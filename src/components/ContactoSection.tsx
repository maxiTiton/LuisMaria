...
export default function ContactoSection() {
  return (
    <section id="contacto" className="relative bg-gradient-to-br from-stone-900 via-neutral-900 to-zinc-900 flex flex-col items-center px-6 py-16 overflow-hidden scroll-mt-48">
      ...
      <div id="contacto" className="scroll-mt-48"></div>
