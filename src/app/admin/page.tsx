...
export default function AdminPage() {
  ...
  if (!autenticado) {
    return (
      <main className="min-h-screen flex flex-col items-center justify-center bg-[#f8f5f2] px-4 py-16 font-serif animate-fade-in">
        ...
        <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-10 shadow-lg border border-[#b08a5a] flex flex-col gap-4 w-full max-w-md">
          <input
            type="password"
          ...
          <button
            onClick={handleLogin}
            className="px-6 py-3 bg-gradient-to-r from-[#b08a5a] to-[#6d4c2b] text-white rounded-full font-bold text-xl shadow-xl hover:from-[#e2d6c2] hover:to-[#b08a5a] hover:text-[#6d4c2b] transition-all duration-300 active:scale-95 font-serif"
          >
            Ingresar
          </button>
        </div>
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center bg-[#f8f5f2] px-4 py-16 font-serif animate-fade-in">
      <h2 className="text-4xl font-serif font-extrabold text-[#6d4c2b] mb-8 drop-shadow-xl text-center">Panel de administración</h2>
      <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-10 shadow-lg border border-[#b08a5a] w-full max-w-2xl">
