export default function UbicacionSection() {
  return (
    <section id="ubicacion" className="relative min-h-[50vh] bg-gradient-to-br from-stone-900 via-neutral-900 to-zinc-900 flex flex-col items-center justify-center px-6 py-16 overflow-hidden">
      ...
      <h2 className="relative text-3xl md:text-4xl font-serif font-bold text-stone-200 mb-8 drop-shadow-lg text-center">Dónde estamos</h2>
